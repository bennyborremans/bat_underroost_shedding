...
if(run.model.fit.again == T) {
       model.fit = stan(model_code = stan.model.prev.Ct,
                        ...
                        iter = 15000,      
                        cores = 5) 
       saveRDS(model.fit,"stan.model.prev.Ct.fit.different.seeds.20220805.RDS")
} else {
       model.fit = readRDS("stan.model.prev.Ct.fit.different.seeds.20220805.RDS")
}
...
if(run.model.fit.again == T) {
       model.fit = stan(model_code = stan.model.prev.Ct,
                        ...
                        iter = 15000,      
                        cores = 5) 
       saveRDS(model.fit,"stan.model.prev.Ct.fit2.different.seeds.20220805.RDS")
} else {
       model.fit = readRDS("stan.model.prev.Ct.fit2.different.seeds.20220805.RDS")
}
